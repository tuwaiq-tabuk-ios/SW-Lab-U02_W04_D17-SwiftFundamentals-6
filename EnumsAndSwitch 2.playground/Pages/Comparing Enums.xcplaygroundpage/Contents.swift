...
enum LunchChoice {
    case rice, chicken, meat
}
// remember you can't put a value that contains tow words
let myLunch = LunchChoice.meat
let yourLunch = LunchChoice.rice
