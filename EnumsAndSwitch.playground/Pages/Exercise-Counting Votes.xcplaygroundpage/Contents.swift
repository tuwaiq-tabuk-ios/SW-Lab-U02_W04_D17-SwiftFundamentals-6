...
print("ChocolateFactory votes are \(chocolateFactoryVotes)")
print("Beach votes are \(beachVotes)")
/*:
 ### Extension:
...
print("Votes for marmot are \(marmot)")
print("Votes for neither are \(neither)")
